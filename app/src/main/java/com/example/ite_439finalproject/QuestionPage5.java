...
public class QuestionPage5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.question_page5);

        final SharedPreferences sp = this.getSharedPreferences("share_name" , Context.MODE_PRIVATE);
        final SharedPreferences.Editor editor = sp.edit();

        answer1 = findViewById(R.id.button19);
        answer2 = findViewById(R.id.button20);
        ...
        answer1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(getApplicationContext(),QuestionPage6.class);
