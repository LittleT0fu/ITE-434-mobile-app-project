...
public class ResultCreative_2 extends AppCompatActivity {

    ImageView Homecreate , previous_create;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.result_creative2);
        ...
        previous_create.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
